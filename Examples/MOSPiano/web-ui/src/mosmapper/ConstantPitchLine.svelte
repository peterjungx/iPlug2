<script lang="ts">
    ...
    import type { edge, system, node, MappedScaleDisplayData, affine_transform } from './lattice_math';
    ...
    function update_line(
        ...
        if(!tune_target){
            apply_lattice_transform([n], s_target, s_tune, display_data.edge_length, dual, affine_t);
            freq_ratio = tuning.coord_to_freq(n.c.aa, n.c.bb);
            //console.log(`node tgt (${node.c.aa},${node.c.bb}), node tune (${n.c.aa},${n.c.bb}), freq=${freq}`);
            line = edge_at_coords({aa:n.c.aa + a_enh, bb:n.c.bb + b_enh}, {aa:n.c.aa - a_enh, bb:n.c.bb - b_enh}, display_data.s_tune, display_data.edge_length, 'black', affine_t);
            apply_lattice_transform([line], s_tune, s_target, display_data.edge_length, dual, affine_t);
        }else{
            freq_ratio = tuning.coord_to_freq(n.c.aa, n.c.bb);
            //console.log(`node tgt (${node.c.aa},${node.c.bb}), node tune (${n.c.aa},${n.c.bb}), freq=${freq}`);
            line = edge_at_coords({aa:n.c.aa + a_enh, bb:n.c.bb + b_enh}, {aa:n.c.aa - a_enh, bb:n.c.bb - b_enh}, display_data.s_tune, display_data.edge_length, 'black', affine_t);
    ...
    $: dx = (2+display_data.s_target.a - _node.c.aa)*unit_dx;
    $: dy = (2+display_data.s_target.a - _node.c.aa)*unit_dy;
    $: node_is_root = (_node.c.aa==0 && _node.c.bb==0) || (_node.c.aa==display_data.s_target.a && _node.c.bb==display_data.s_target.b);
