...
export function SMMFD(ctrlTag: number, msgTag: number, dataSize: number, msg: string) {
  //console.log("SMMFD ctrlTag: " + ctrlTag + " msgTag:" + msgTag + " dataSize:" + dataSize + " msg:" + msg);
}
