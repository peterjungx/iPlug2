...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MOXplore Demo Installer\n"
      else:
        line="OutputBaseFilename=MOXplore Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MOXplore Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MOXplore installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MOXplore Demo installer\n"
     else:
       line="SetupWindowTitle=MOXplore installer\n"
